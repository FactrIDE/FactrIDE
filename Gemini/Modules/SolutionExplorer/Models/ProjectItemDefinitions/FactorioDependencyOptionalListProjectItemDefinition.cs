...
{
    [Export]
    public class FactorioDependencyOptionalListProjectItemDefinition : ProjectItemDefinition
    {
        private readonly ICommandService _commandService;

        [ImportingConstructor]
        public FactorioDependencyOptionalListProjectItemDefinition(ICommandService commandService)
        {
        ...
        public override Uri GetIcon(bool isOpen, object tag) =>
            new Uri("pack://application:,,,/Resources/VS17/ZipFileWarning_16x.png");
    }
}